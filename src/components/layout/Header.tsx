...
export const Header = () => {
  return (
    <header className="h-[64px] bg-black text-white flex items-center justify-between">
      <div className="container flex items-center justify-between sm:mx-auto mx-4">
        {/* Logo */}
